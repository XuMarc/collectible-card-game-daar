...
contract Main is Ownable {
    ...
    function createCollectionWithCards(
        ...
        Collection collection = new Collection(id, address(this), name, cardCount, _cards);
    ...
    function getCollectionById(string calldata id) public view returns (Collection) {
        return collectionsById[id];
    }

    // Fonction pour obtenir les cartes d'une collection spécifique
    function getCardsInCollection(string calldata id) public view returns (Collection.Card[] memory) {
